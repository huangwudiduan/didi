...
import numpy as np
def calculate_map(pred_bboxes_list, gt_bboxes_list, iou_threshold=0.5):
    """
    计算mAP
    pred_bboxes_list: 所有类别的预测边界框列表，每个元素是一个类别的预测边界框列表
    gt_bboxes_list: 所有类别的真实边界框列表，每个元素是一个类别的真实边界框列表
...
# 示例数据
pred_bboxes_list = [
    [(50, 50, 150, 150), (30, 30, 100, 100), (60, 60, 200, 200), (70, 70, 120, 120)],  # 类别1的预测框
    [(20, 20, 80, 80), (25, 25, 75, 75)]  # 类别2的预测框
]

gt_bboxes_list = [
    [(55, 55, 160, 160)],  # 类别1的真实框
    [(30, 30, 70, 70)]  # 类别2的真实框
]

map_value = calculate_map(pred_bboxes_list, gt_bboxes_list)
