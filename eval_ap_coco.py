...
if __name__ == "__main__":
    ...
    # pred: 0.json, 1.json, ...
    # gt: 0.json, 1.json, ...
    gt_dir = '/home/ubuntu/jt/dinovdemo/didi2/MovableBarrierInfer/targets'
    pred_dir = '/home/ubuntu/jt/dinovdemo/didi2/MovableBarrierInfer/results'
